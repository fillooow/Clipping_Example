package fillooow.app.clippingexample
...
class ClippedView @JvmOverloads constructor(
    ...
    private fun drawClippedRectangle(canvas: Canvas) {
        ...
        // Вырезаем маленький прямоугольник и заливаем его белым
        canvas.clipRect(clipRectLeft, clipRectTop, clipRectRight, clipRectBottom)
        canvas.drawColor(Color.WHITE)

        // Рисуем в этом прямоугольнике красную диагональную линию
        ...
        // Рисуем синий текст в правой части
        paint.color = Color.BLUE
        paint.textSize = textSize
        // Если было бы LEFT, текст бы выровнялся по левой стороне слова и был бы за границей прямоугольника
    ...
    private fun drawDifferenceClippingExample(canvas: Canvas) {
        ...
        // рисует внутренний прямоугольник
